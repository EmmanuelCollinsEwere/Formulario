...
function Register() {
  return (
        <div className='mx-auto my-auto w-full flex flex-col justify-center items-center mt-16 px-1 py-8 bg-white shadow rounded-lg m-auto'>
            <div id='Presentacion-IS' className='py-2'>
                <h1 style={{fontWeight: 'bold'}} className='texto text-lg'>REGISTRATE</h1>
            </div>
        <div id='ETPV' className='py-2'>
            <p>¿Ya estás registrado? <a href="#"><span style={{textDecoration: 'underline'}}>Inicia Sesión</span></a></p>
        </div>
        <div id='User' className='py-2 flex flex-col'>
            <label for="required-user" className="text-gray-700">
                <span className="text-red-500 required-dot">*</span>Usuario:
            </label>
            <input type="text" id="required-user" className=" rounded-lg  flex-2 appearance-none border border-gray-300 w-64 py-1 px-1 bg-white text-gray-700 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent" name="email"/>
        </div>
